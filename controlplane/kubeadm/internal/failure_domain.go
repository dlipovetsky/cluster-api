...
func PickMost(failureDomains clusterv1.FailureDomains, machines MachineSet) string {
...
func PickFewest(failureDomains clusterv1.FailureDomains, machines MachineSet) string {
	aggregations := pick(failureDomains, machines)
	if len(aggregations) == 0 {
		return ""
	}
...
func pick(failureDomains clusterv1.FailureDomains, machines MachineSet) failureDomainAggregations {
